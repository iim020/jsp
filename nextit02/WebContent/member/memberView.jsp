...
<script>
	function fn_memberEdit(memId) {
		...
		location.href = "${pageContext.request.contextPath}/member/memberEdit.jsp?memId="
				+ memId;
	}
	function fn_memberDelet() {
		alert("변경완료")
	...
	function fn_memberDeleteSubmit(memberPass) {

		console.log($('input[name=memPass]').val())
		/* 		console.log("memId:" + ${member.memPass }); */
...
<body>
	...
	try{
		memberService.passCheck(memPass);
	...
	<div id="wrap">
						...
						<c:when test="${bne eq null and de eq null}">
							<table>
								<tbody>
									...
									<tr>
										...
										<td class="td_right"><c:out
												value="${member.memAdd1 } ${member.memAdd2 }" /></td>
									</tr>
									<tr>
										<td class="td_left">생일</td>
										<td class="td_right"><input type="date" name="memBir"
							...
							<div class="div_button">
								<input type="button"
									...
									value="HOME"> <input type="button"
									onclick="fn_memberEdit('${member.memId }')" value="수정">
								<%-- <input type="button"
									onclick="location.href='${pageContext.request.contextPath}/member/memberDelete.jsp?memId=${member.memId }'"
									value="탈퇴"> --%>
								<input type="button" onclick="fn_memberDelet()" value="탈퇴">
		...
		<div id="modal_div1">
			<div id="modal_div2">
				<form name="deleteForm"
					action="${pageContext.request.contextPath}/member/memberDelete.jsp"
					method="post">
