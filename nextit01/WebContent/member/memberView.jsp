...
<script type="text/javascript">
	...
	function fn_memberDelect(memId) {
		//alert("memId: " + memId);
					...
					<c:choose>
						...
						<c:when test="${error eq null and bne eq null }">
								...
								<tbody>
									...
									<tr>
										...
										<td class="td_right"><c:out
												value="${member.memAdd1} ${member.memAdd2}"></c:out></td>
									</tr>
									<tr>
										<td class="td_left">생일</td>
										<td class="td_right"><input type="date" name="memBir"
											value="${member.memBir}" readonly="readonly"></td>
									</tr>
									<tr>
							...
							<div class="div_button">
								<input type="button"
									onclick="location.href='${pageContext.request.contextPath}/home/hoem.jsp'"
									value="HOME"> <input type="button"
									onclick="fn_memberEdit('${member.memId}')" value="수정">
								<input type="button" onclick="fn_memberDelect('${member.memId}')" value="삭제">
